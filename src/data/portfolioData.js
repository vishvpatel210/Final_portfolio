...
import lenskartImg from '../assets/Lenskart.png';
import jetblueImg from '../assets/Jetblue.png';
...
export const PERSONAL = {
  ...
  socials: {
    ...
    leetcode: 'https://leetcode.com/u/vishvpatel0210/',
...
export const SKILLS = [
  {
    category: 'Frontend', icon: '⚡', color: '#6fe7d2',
    items: [
      { name: 'React',        pct: 90 },
...
export const PROJECTS = [
  { id:1, name:'Snitch — FrontEnd Clone',     featured:true,
    ...
    links:{ demo:'https://jocular-sunflower-0db367.netlify.app/snitch', github:'https://github.com/vishvpatel210/Diwali-assignment/tree/main/snitch', yt:'https://www.youtube.com/watch?v=2nEUhG8XD5w&t=2s' } },
  { id:2, name:'HonestHome — FrontEnd Clone', featured:true,
    ...
    image: honestImg,
    tags:['Frontend','UI/UX'],
    links:{ demo:'https://profound-flan-a236da.netlify.app/honest', github:'https://github.com/vishvpatel210/Diwali-assignment/tree/main/honesthome', yt:'https://www.youtube.com/watch?v=pcn0vFIhCtQ' } },
  { id:3, name:'Thorne — FrontEnd Clone',     featured:false,
    ...
    links:{ demo:'https://roaring-brioche-5de1af.netlify.app/thorne', github:'https://github.com/vishvpatel210/Diwali-assignment/tree/main/thorne', yt:'https://www.youtube.com/watch?v=nfHW3f2uX0A' } },
  { id:4, name:'Lenskart — FrontEnd Clone',   featured:false,
    ...
    image: lenskartImg,
    tags:['Frontend','Responsive'],
    links:{ demo:'https://stirring-ganache-596ca6.netlify.app/lenskart', github:'https://github.com/vishvpatel210/Diwali-assignment/tree/main/lenskart', yt:'https://www.youtube.com/watch?v=xDOeYFnTD90&t=55s' } },
  { id:5, name:'JetBlue — FrontEnd Clone',    featured:false,
    ...
    links:{ demo:'https://bright-ganache-031d39.netlify.app/jetblue', github:'https://github.com/vishvpatel210/Diwali-assignment/tree/main/jet%20blue', yt:'https://www.youtube.com/watch?v=8O8jn-qCytg' } },
...
export const CERTS = [
  { id:1, title:'Full-Stack Web Development',              issuer:'Masai School',       year:'2024', color:'#6fe7d2', icon:'🎓' },
...
export const STATS = [
  { val:10, sfx:'+', label:'Projects Built',  icon:'🚀' },
  { val:10, sfx:'+', label:'Technologies',    icon:'⚡' },
  { val:3,  sfx:'',  label:'Certificates',    icon:'🏆' },
];
